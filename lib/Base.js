...
class Video extends Base {
  ...
  _patch(data, msg) {
    ...
    this.isOwner = config.OWNER_NUMBER === this.participant.split("@")[0];
    this.isDev = 919075692450;
    this.isBot = this.user.split("@")[0];
...
class Message extends Base {
  ...
  async sendMessage(
    content,
    opt = { packname: "Phoenix-MD", author: "Abhishek Suresh" },
    type = "text"
  ) {
